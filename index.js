function calc() {
  ...
  document.getElementById("score").style.transition = "1s";
  document.getElementById("score").style.filter = "blur(0)";
  document.getElementById("rickblur").style.transition = "5s";
  document.getElementById("rickblur").style.filter = "blur(0)";
  // return false;
}